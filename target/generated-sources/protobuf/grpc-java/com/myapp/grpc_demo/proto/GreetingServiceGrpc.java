...
public final class GreetingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.myapp.grpc_demo.proto.HelloRequest,
      com.myapp.grpc_demo.proto.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = com.myapp.grpc_demo.proto.HelloRequest.class,
      responseType = com.myapp.grpc_demo.proto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.myapp.grpc_demo.proto.HelloRequest,
      com.myapp.grpc_demo.proto.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.myapp.grpc_demo.proto.HelloRequest, com.myapp.grpc_demo.proto.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<com.myapp.grpc_demo.proto.HelloRequest, com.myapp.grpc_demo.proto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myapp.grpc_demo.proto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.myapp.grpc_demo.proto.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(com.myapp.grpc_demo.proto.HelloRequest request,
        io.grpc.stub.StreamObserver<com.myapp.grpc_demo.proto.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.myapp.grpc_demo.proto.HelloRequest,
                com.myapp.grpc_demo.proto.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.myapp.grpc_demo.proto.HelloResponse greeting(com.myapp.grpc_demo.proto.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.myapp.grpc_demo.proto.HelloResponse> greeting(
        com.myapp.grpc_demo.proto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.myapp.grpc_demo.proto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.myapp.grpc_demo.proto.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.myapp.grpc_demo.proto.Test.getDescriptor();
    }
